	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">
					<br />
					<a href="<?php echo site_url('pp/input'); ?>" class="btn btn-sm btn-info" id="a_pp_baru"><span class="fa fa-plus"></span> PP Baru</a>
								...
								<div class="row">
									<div class="col-md-5">
										...
										<div class="form-group">
											...
											<div class="col-md-7 col-sm-6 col-xs-12">
												<input id="txt_nilai_po" name="txt_nilai_po" class="form-control col-md-7 col-xs-12 currencyduadigit" required="required" type="text" placeholder="Nilai PO" onkeyup="hitungTotalPO()" value="0" readonly="">
											</div>
										</div>
										<div class="form-group">
									...
									<div class="col-md-5">
										...
										<div class="form-group">
											...
											<div class="col-md-8 col-sm-6 col-xs-12">
												<input id="txt_jumlah" name="txt_jumlah" class="form-control col-md-7 col-xs-12 currencyduadigit" required="required" type="text" placeholder="Jumlah" onkeyup="getTerbilang()">
											</div>
										</div>
										<div class="form-group">
  	...
  	function tableDataPO(){
    	...
    	$('#tableDataPO').DataTable({
			...
			"fnRowCallback": function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
				...
				let d6 = parseFloat(aData[6]);
				let d7 = parseFloat(aData[7]);
				let d8 = parseFloat(aData[8]);
				console.log(d6+d7);
				if((d6+d7) <= d8){
					nRow.style.display = nRow.style.display == "none" ? "table-row" : "none";
					//$('td', nRow).style.display = $('td', nRow).style.display == "none" ? "table-row" : "none";
				}
          	},
          	"ajax"            : {
