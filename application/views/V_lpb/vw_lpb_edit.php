	        ...
	        success: function(data){
				...
				$.each(data.data_masukitem, function(index,value){
					...
					var td_col_1 = '<td>'
										...
										//+'<button class="btn btn-xs btn-danger fa fa-minus btn_hapus_row" type="hidden" data-toggle="tooltip" data-placement="left" title="Hapus" id="btn_hapus_row_'+n+'" name="btn_hapus_row_'+n+'" onclick="hapus_row('+n+')"></button>'
									+'</td>';
					...
					var td_col_5 = '<td>'
										...
										+'<input type="hidden" id="hidden_grup_'+n+'" name="hidden_grup_'+n+'">'
									+'</td>';
					var td_col_6 = '<td>'
					...
					if(data.data_real_qty_terima[index]== null){
						data.data_real_qty_terima[index] = 0;
					}
					...
					$('#lbl_grup_'+n).html('Grup : '+data.data_masukitem[index].grp);
					$('#hidden_grup_'+n).val(data.data_masukitem[index].grp);
