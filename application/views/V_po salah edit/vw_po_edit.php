...
<script>
	        ...
	        success: function(data){
	        	...
	        	$.each(data.item_po,function(index,value){
					...
					var td_col_2 = '<td width="20%">'
				    				...
				    				+'<input type="hidden" id="hidden_no_spp_'+n+'" name="hidden_no_spp_'+n+'">'
					...
					$('#hidden_no_spp_'+n).val(data.item_po[index].noppotxt);
					$('#hidden_no_ref_spp_'+n).val(data.item_po[index].refppo);
					console.log(data.item_po[index].noppotxt);
					console.log($('#hidden_no_spp_'+n).val());
					console.log($('#hidden_no_ref_spp_'+n).val());
        ...
        $.ajax({
	        ...
	        success: function(data){
            	...
            	$.each(data[1],function(index){
					...
					$('#hidden_no_spp_'+n).val(data[0].noppotxt);
  ...
  //   	$('#tableRinciPO tbody #tr_'+no+' td').find('#txt_no_spp_'+no+',#txt_cari_kode_brg_'+no+',#cmb_kurs_'+no+',#btn_simpan_'+no).removeAttr('disabled');
    ...
    function updateData(no){
		...
		// console.log($('#hidden_no_po').val());
		// console.log($('#hidden_no_ref_po').val());
		// console.log($('#hidden_no_spp_'+no).val());
		// console.log($('#hidden_no_ref_spp_'+no).val());

		form_data.append('hidden_no_po',$('#hidden_no_po').val());
		form_data.append('hidden_no_ref_po',$('#hidden_no_ref_po').val());

		form_data.append('hidden_no_spp',$('#hidden_no_spp_'+no).val());
		form_data.append('hidden_no_ref',$('#hidden_no_ref_spp_'+no).val());

		// form_data.append('hidden_no_spp',$('#hidden_no_spp_'+no).val());
		// form_data.append('hidden_no_ref',$('#hidden_no_ref_'+no).val());
