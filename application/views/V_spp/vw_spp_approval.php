...
<div class="">
	...
	<div class="modal fade" tabindex="-1" role="dailog" aria-hidden="true" id="modalApprovalSPP">
		<div class="modal-dialog modal-xl">
			<div class="modal-content">
				...
				<div class="modal-body">
					<table id="tableApprovalSPP" class="table table-bordered">
						<thead>
							<tr>
								<th>No</th>
								<th>No. SPP</th>
								...
								<th>Status PO</th>
								<th>Kasie Gudang</th>
								<th>Kasie Mill Mgr</th>
								<th>Asisten Afd</th>
								<th>Kasie Dept.</th>
								<th>Kasie HRGA</th>
								<th>KTU</th>
								<th>GM</th>
								<th>Dept. Head HRGA</th>
								<th>Dir. Dept</th>
							</tr>
						</thead>
						<tbody id="tbody_approval_spp"></tbody>
					</table>
				</div>
...
<script>
	...
	function listSPP() {
		...
		var dt = $('#tableListSPP').DataTable({
			...
			"ajax": {
				"url": "<?php
						if ($url == 1)
							echo site_url('spp/list_approval/1');
						else
							echo site_url('spp/list_approval/0'); ?>",
				"type": "POST",
			},
			"columns": [{
					"data": "0.0"
	...
	function promptQty(id, noppotxt, satuan) {
