				...
				<div class="x_content">
					...
					<div id="" data-parsley-validate class="form-horizontal form-label-left">
						...
						<!-- <div class="form-group div_form_1">
							...
							<div class="col-md-2 col-sm-6 col-xs-12">
								<input id="txt_tanggal" name="txt_tanggal" class="form-control col-md-2 col-xs-12" required="required" type="text" data-date-format="yyyy-mm-dd" placeholder="Tgl. SPP" value="<?php // echo date('m/d/Y') 
																																																				?>" readonly>
							</div>
						</div> -->
						<!-- <div class="form-group div_form_1">
								...
								<div class="row">
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<div class="col-md-3 col-sm-6 col-xs-12">
												<input id="txt_kode_supplier" name="txt_kode_supplier" class="form-control col-md-7 col-xs-12" required="required" type="text" placeholder="Kode Supplier" onfocus="tampilModalSupplier()">
											</div>
											<div class="col-md-5 col-sm-6 col-xs-12">
...
<script>
	...
	// $('#cmb_lokasi_pembelian').change(function(){
	...
	function pilihEST() {
		...
		// console.log(est);
		$('#_est').remove();
		$('#txt_estate').append('<label class="control-label col-md-6 col-sm-6 col-xs-12" id="_est">Kebun ' + est + '</label>');
	...
	function tableDetailSPP(filter) {
		...
		var rel = setInterval(function() {
			$('#tableDetailSPP').DataTable().ajax.reload();
			clearInterval(rel);
		}, 100);
	}
			...
			success: function(data) {
				if (data == "kodebar_exist") {
					...
					if (data.status == true) {
						...
						swal('Terjadi kesalahan! Perhatikan koneksi jaringan Anda');
	...
	function hapusRinci(no) {
		...
		//console.log($('#hidden_no_ref_spp_'+no).val());
	}
