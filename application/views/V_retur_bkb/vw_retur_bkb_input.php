							...
							<tbody id="tbody_rincian" name="tbody_rincian">
								...
								<form id="form_rinci_1" name="form_rinci_1" method="POST" action="javascript:;">
									...
									<td>
										...
										<label>Qty BKB : <b id="b_qty_bkb_1" name="b_qty_bkb_1"></b> </label>
										<label>Sudah Pernah Retur : <b id="b_qty_sdh_pernah_ret_1" name="b_qty_sdh_pernah_ret_1"></b> </label>
	...
	function getBKBItem(kode_barang, row, no_bkb, no_ref_bkb){
		...
		$.ajax({
	        ...
	        success: function(data){
	        	...
	        	var sudah_ret;
	        	console.log(data.data_ret_skbitem);
