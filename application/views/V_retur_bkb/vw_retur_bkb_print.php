...
<body>
  <table border="0" width="100%">
    <tr>
      <td rowspan="2" width="12%"><img width="10%" height="10%" src="./assets/qrcode/qr/lpb/<?php echo $id."_".$no_lpb;?>.png"></td>
      <td align="center" valign="bottom"><h4 align="center" style="margin: 0px;padding: 0px;"><b><u>Laporan Penerimaan Barang</u></b></h4></td>
    </tr>
    <tr>
      <td align="center" valign="baseline"><h5 align="center" style="margin: 0px;padding: 0px 0px 10px 0px;"><b>No. LPB : <?= $stokmasuk->noref; ?></b></h5></td>  
    </tr>
  </table>
  <table border="0" width="100%">
    <tr>
